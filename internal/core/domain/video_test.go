...
func TestVideo(t *testing.T) {
	t.Run("NewVideo", func(t *testing.T) {
		...
		video := NewVideo(filePath, outputDir)
	...
	t.Run("OutputPath", func(t *testing.T) {
		video := NewVideo("/input/movie.mkv", "/output")
	...
	t.Run("FilenameWithComplexPath", func(t *testing.T) {
		video := NewVideo("/home/user/Videos/films/my-movie-2024.mkv", "/output")
	...
	t.Run("VideoWithMultipleExtensions", func(t *testing.T) {
		...
		for _, tt := range tests {
			t.Run(tt.name, func(t *testing.T) {
				video := NewVideo(tt.filePath, "/output")
